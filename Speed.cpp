...
std::string Speed::setDifficulty(){
    std::cout << "Hello " << name << "! Please choose your difficulty!\nE is for EASY\nN is for NORMAL\nH is for HARD\nU is for ULTRA\n";
